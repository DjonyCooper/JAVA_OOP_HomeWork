package Java.OOP_6.isp1;

import Java.OOP_6.isp1.pay.impl.InternetPaymentService;
import Java.OOP_6.isp1.pay.impl.TerminalPaymentService;
...
//        terminalService.payPhoneNumber(10);  // Ошибка компилятора
    }
}
